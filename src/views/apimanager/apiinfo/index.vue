<template>
  <div class="api-info">
    <div class="title">
      ...
      <span class="time">更新时间: {{ apiInfo.time }}</span>
    </div>
    <div class="status">
      <el-tag color="green" style="color:white;" size="small">{{ apiInfo.status[0] }}</el-tag>
      <el-tag color="deepskyblue" style="color:white" size="small">{{ apiInfo.status[1] }}</el-tag>
      <el-tag color="lightsalmon" style="color:maroon" size="small">{{ apiInfo.status[2] }}</el-tag>
    </div>
    <div class="describe">
      <el-row class="row">
        <label>
        ...
        <label>
          接口状态：
          <span>{{ apiInfo.interfaceStatus }}</span>
        </label>
      </el-row>
      <el-row class="row">
        <label>
